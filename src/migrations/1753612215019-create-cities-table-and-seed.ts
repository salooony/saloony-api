...
export class CreateCitiesTableAndSeed1753612215019 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      ('Ramallah', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Gaza City', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Bethlehem', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Nablus', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Jericho', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Hebron', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Jenin', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Tulkarem', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW()),
      ('Jerusalem', (SELECT id FROM countries WHERE code = 'PS'), NOW(), NOW())
    `);
  }
